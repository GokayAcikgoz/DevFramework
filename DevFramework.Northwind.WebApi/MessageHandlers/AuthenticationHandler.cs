            ...
            try
            {
                ...
                if (token!=null)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        Thread.CurrentPrincipal = principal; //backendeimizdeki ıdentity set edilmiş olur.
                        HttpContext.Current.User = principal; //webapi de authorized i rolleriyle beraber kullanabiliriz.
                    }
                }
            }
            catch
